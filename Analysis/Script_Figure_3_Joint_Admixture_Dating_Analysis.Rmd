...
We used a snakemake script to do the simulation that calls 4 different R scripts. Parameters are read in from a yaml file.

```{r eval=T,echo=F, result='hide'}


path_SP <- list.files(path = "/mnt/diversity/leonardo_iasi/EMH_Introgression_Project/EMH_dating_analysis/Test_Sim/",pattern = "SP_sim_",full.names = T)
...
path_TP <- list.files(path = "/mnt/diversity/leonardo_iasi/EMH_Introgression_Project/EMH_dating_analysis/Test_Sim/",pattern = "TP_sim_",full.names = T)
...
path_EP_1600_400 <- list.files(path = "/mnt/diversity/leonardo_iasi/EMH_Introgression_Project/EMH_dating_analysis/Test_Sim/",pattern = "EP_sim_0.015_tm_td_comb_1600_400",full.names = T)
...
path_EP_1600_1 <- list.files(path = "/mnt/diversity/leonardo_iasi/EMH_Introgression_Project/EMH_dating_analysis/Test_Sim/",pattern = "EP_sim_0.015_tm_td_comb_1600_1",full.names = T)
...
path_EP_1600_200 <- list.files(path = "/mnt/diversity/leonardo_iasi/EMH_Introgression_Project/EMH_dating_analysis/Test_Sim/",pattern = "EP_sim_0.015_tm_td_comb_1600_200",full.names = T)
...
path_EP_1700_400 <- list.files(path = "/mnt/diversity/leonardo_iasi/EMH_Introgression_Project/EMH_dating_analysis/Test_Sim/",pattern = "EP_sim_0.015_tm_td_comb_1700_400",full.names = T)
...
path_EP_1800_600 <- list.files(path = "/mnt/diversity/leonardo_iasi/EMH_Introgression_Project/EMH_dating_analysis/Test_Sim/",pattern = "EP_sim_0.015_tm_td_comb_1800_600",full.names = T)
...
path_EP_1900_800 <- list.files(path = "/mnt/diversity/leonardo_iasi/EMH_Introgression_Project/EMH_dating_analysis/Test_Sim/",pattern = "EP_sim_0.015_tm_td_comb_1900_800",full.names = T)
...
path_EP_2000_1000 <- list.files(path = "/mnt/diversity/leonardo_iasi/EMH_Introgression_Project/EMH_dating_analysis/Test_Sim/",pattern = "EP_sim_0.015_tm_td_comb_2000_1000",full.names = T)
...
JK_ACov <- read.csv("~/EMH_Introgression_Project/Introgression_Detection/Coancestry_Curves_Dating/ACov_Datinf_asc.snp",sep=" ",header = F) %>% 
  dplyr::select(V1,V2) %>% group_by(V1) %>% dplyr::summarize(n_pos = n())


SP_Acov <- read.csv("/mnt/diversity/leonardo_iasi/EMH_Introgression_Project/EMH_dating_analysis_res_updated_red/Fit_data_tm_step_1_td_step_1/Results/All_ACov_SP_res_merged_ACov_Run_SP.csv") %>% mutate( JK = ifelse(JKchrom == "All", F,T), exclude = ifelse(exclude == "", "All_Data", exclude)) 
...
for(i in 1:length(est$truncation)){
  ...
  write.table(x = data.frame(ACov_Run_SP_JKchrom_summary$JKchrom,ACov_Run_SP_JKchrom_summary$n_pos,ACov_Run_SP_JKchrom_summary$tm),file = paste0("/mnt/diversity/leonardo_iasi/EMH_Introgression_Project/EMH_dating_analysis_res_updated_red/Fit_data_tm_step_1_td_step_1/JKResults/ACov_Run_EP_JKchrom_sum_tm_",est$truncation[i],"_",est$weighted[i],"_",est$exclude[i],".jin"),quote = F,row.names = F,col.names = F)

  system(paste0("~/DATES/src/./dowtjack -i /mnt/diversity/leonardo_iasi/EMH_Introgression_Project/EMH_dating_analysis_res_updated_red/Fit_data_tm_step_1_td_step_1/JKResults/ACov_Run_EP_JKchrom_sum_tm_",est$truncation[i],"_",est$weighted[i],"_",est$exclude[i],".jin -m ",ACov_Run_SP_JKchrom_mean$tm," -o /mnt/diversity/leonardo_iasi/EMH_Introgression_Project/EMH_dating_analysis_res_updated_red/Fit_data_tm_step_1_td_step_1/JKResults/ACov_Run_EP_JKchrom_sum_tm_",est$truncation[i],"_",est$weighted[i],"_",est$exclude[i],".jout"))

  tm_SE_est_SP <- read.table(paste0("/mnt/diversity/leonardo_iasi/EMH_Introgression_Project/EMH_dating_analysis_res_updated_red/Fit_data_tm_step_1_td_step_1/JKResults/ACov_Run_EP_JKchrom_sum_tm_",est$truncation[i],"_",est$weighted[i],"_",est$exclude[i],".jout"))
...
write.table(SP_Acov_anno,"/mnt/diversity/leonardo_iasi/EMH_Introgression_Project/EMH_dating_analysis_res_updated_red/Fit_data_tm_step_1_td_step_1/Results/All_ACov_SP_res_merged_ACov_Run_SP_annotated.csv",quote = F,row.names = F,sep=",")

## Seg

JK_segments <- read.csv("~/EMH_Introgression_Project/Introgression_Detection/admixfrogREF/ref/published/EMHPanel/Shared_Map/ref_archaicadmixtureAPX_hs37mMask35to99.csv.xz") %>%
  filter(chrom != "X") %>%
  group_by(chrom) %>% dplyr::summarize(chrom_start = min(pos),chrom_end = max(pos)) %>% mutate(chrom_length = chrom_end - chrom_start)

SP_Seg <- read.csv("/mnt/diversity/leonardo_iasi/EMH_Introgression_Project/EMH_dating_analysis_res_updated_red/Fit_data_tm_step_1_td_step_1/Results/All_Seg_SP_res_merged_Seg_Run_SP.csv") %>% 
...
for(i in 1:length(est$min_l)){
  ...
  write.table(x = data.frame(Seg_Run_SP_JKchrom_summary$JKchrom,Seg_Run_SP_JKchrom_summary$chrom_length,Seg_Run_SP_JKchrom_summary$tm),file = paste0("/mnt/diversity/leonardo_iasi/EMH_Introgression_Project/EMH_dating_analysis_res_updated_red/Fit_data_tm_step_1_td_step_1/JKResults/Seg_Run_EP_JKchrom_sum_tm_",est$min_l[i],"_",est$exclude[i],".jin"),quote = F,row.names = F,col.names = F)

  system(paste0("~/DATES/src/./dowtjack -i /mnt/diversity/leonardo_iasi/EMH_Introgression_Project/EMH_dating_analysis_res_updated_red/Fit_data_tm_step_1_td_step_1/JKResults/Seg_Run_EP_JKchrom_sum_tm_",est$min_l[i],"_",est$exclude[i],".jin -m ",Seg_Run_SP_JKchrom_mean$tm," -o /mnt/diversity/leonardo_iasi/EMH_Introgression_Project/EMH_dating_analysis_res_updated_red/Fit_data_tm_step_1_td_step_1/JKResults/Seg_Run_EP_JKchrom_sum_tm_",est$min_l[i],"_",est$exclude[i],".jout"))

  tm_SE_est_SP <- read.table(paste0("/mnt/diversity/leonardo_iasi/EMH_Introgression_Project/EMH_dating_analysis_res_updated_red/Fit_data_tm_step_1_td_step_1/JKResults/Seg_Run_EP_JKchrom_sum_tm_",est$min_l[i],"_",est$exclude[i],".jout"))
...
write.csv(SP_Seg_anno,"/mnt/diversity/leonardo_iasi/EMH_Introgression_Project/EMH_dating_analysis_res_updated_red/Fit_data_tm_step_1_td_step_1/Results/All_Seg_SP_res_merged_Seg_Run_SP_annotated.csv",quote = F,row.names = F)
```

## Estimating Jackknife se by chrom for EP

This seems to return strange SE where the estimated mean is not found in the range of the jackknifed values
...
ACov_Run_EP_JKchrom <- read.csv("/mnt/diversity/leonardo_iasi/EMH_Introgression_Project/EMH_dating_analysis_res_updated_red/Data_JKchrom/Results/All_ACov_EP_res_merged_ACov_Run_EP_JKchrom.csv")

ACov_Run_EP  <- read.csv("/mnt/diversity/leonardo_iasi/EMH_Introgression_Project/EMH_dating_analysis_res_updated_red/Fit_Data_10_10_steps/Results/All_ACov_EP_res_merged_ACov_Run_EP.csv") %>% 
  ...
  filter(min_l == 0.02, weighted == "yes", 
         truncation == "estimated_truncation",
         map == "Shared_Map",
         exclude2 %in% c("EarlyOoA Excluded")) %>% filter(value0 == 0)

ACov_Run_EP_JKchrom_summary <- ACov_Run_EP_JKchrom %>% group_by(JKchrom,exclude) %>% filter(value0 == 0) %>% ungroup() %>% inner_join(.,JK_ACov,by=c("JKchrom"="V1"))

## estimate SE tm 

write.table(x = data.frame(ACov_Run_EP_JKchrom_summary$JKchrom,ACov_Run_EP_JKchrom_summary$n_pos,ACov_Run_EP_JKchrom_summary$Var2),"~/EMH_Introgression_Project/Introgression_Detection/Coancestry_Curves_Dating/ACov_Run_EP_JKchrom_sum_tm.jin",quote = F,row.names = F,col.names = F)

system(paste0("~/DATES/src/./dowtjack -i ~/EMH_Introgression_Project/Introgression_Detection/Coancestry_Curves_Dating/ACov_Run_EP_JKchrom_sum_tm.jin -m ",ACov_Run_EP$Var2," -o ~/EMH_Introgression_Project/Introgression_Detection/Coancestry_Curves_Dating/ACov_Run_EP_JKchrom_sum_tm.jout"))

tm_SE_est_EP <- read.table("~/EMH_Introgression_Project/Introgression_Detection/Coancestry_Curves_Dating/ACov_Run_EP_JKchrom_sum_tm.jout")

## estimate SE td 

write.table(x = data.frame(ACov_Run_EP_JKchrom_summary$JKchrom,ACov_Run_EP_JKchrom_summary$n_pos,ACov_Run_EP_JKchrom_summary$Var1),"~/EMH_Introgression_Project/Introgression_Detection/Coancestry_Curves_Dating/ACov_Run_EP_JKchrom_sum_td.jin",quote = F,row.names = F,col.names = F)

system(paste0("~/DATES/src/./dowtjack -i ~/EMH_Introgression_Project/Introgression_Detection/Coancestry_Curves_Dating/ACov_Run_EP_JKchrom_sum_td.jin -m ",as.numeric(ACov_Run_EP$Var1)," -o ~/EMH_Introgression_Project/Introgression_Detection/Coancestry_Curves_Dating/ACov_Run_EP_JKchrom_sum_td.jout"))

td_SE_est_EP <- read.table("~/EMH_Introgression_Project/Introgression_Detection/Coancestry_Curves_Dating/ACov_Run_EP_JKchrom_sum_td.jout")
...
```{r eval=T,echo=F, result='hide'}
ACov_Run_EP  <- read.csv("/mnt/diversity/leonardo_iasi/EMH_Introgression_Project/EMH_dating_analysis_res_updated_red/Fit_data_tm_step_1_td_step_1/Results/All_ACov_EP_res_merged_ACov_Run_EP.csv") %>% 
  mutate(exclude2 = ifelse(exclude == "", "All Data",ifelse(startsWith(exclude,"BKBB7240_BKF6620"), "EarlyOoA Excluded",ifelse(exclude == "OaseNew","Oase Excluded",ifelse(startsWith(exclude,"OaseNew_PM1"),"Only EarlyOoA w/o Oase","Only EarlyOoA"))))) 
  group_by(truncation,exclude,min_l,map,weighted) %>% filter(value0 > -101) 

write.csv(x=ACov_Run_EP,file = "/mnt/diversity/leonardo_iasi/EMH_Introgression_Project/EMH_dating_analysis_res_updated_red/Fit_data_tm_step_1_td_step_1/Results/All_ACov_EP_res_merged_ACov_Run_EP_reduced.csv",quote = F,row.names = F)
